...
function createConfettiPiece(container, isEmoji, symbols, colors) {
...
function createConfetti() {
    ...
    for (let i = 0; i < count; i++) {
        ...
        createConfettiPiece(container, isEmoji, CONFETTI_SYMBOLS, CONFETTI_COLORS);
    }
}
